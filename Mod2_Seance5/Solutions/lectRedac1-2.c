...
typedef struct {              /* buffer circulaire d'entiers                */
    ...
    sem_t semBufferPlein;     /* nombre de compartiments à lire             */
    sem_t semBufferVide;      /* nombre de compartiments à remplir          */
    /*  ............................ à compléter  ......................... */
} circBuffer_t;
...
void init(circBuffer_t * b)
{
    ...
    for (i = 0; i < NBMAX_BUFFER; i++)
        b->buffer[i] = OVER;
    CHECK(sem_init(&b->semBufferVide,  0, NBMAX_BUFFER), "sem_init(semVide)");
    CHECK(sem_init(&b->semBufferPlein, 0,         0 ), "sem_init(semPlein)");
    /*  ............................ à compléter  ......................... */
}
